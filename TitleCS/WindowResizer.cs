...
namespace WinResizer
{
    public class WindowResizer
    {
        ...
        public WindowResizer(Window target)
        {
            ...
            if (target == null)
            {
                throw new Exception(ClsSynchronizer.VmSyncCADs.GetLanguageByKeyName("msg_InvalidWindow"));
            }
        }
        ...
        private void element_MouseLeftButtonDown(object sender, MouseButtonEventArgs e)
        {
            ...
            ResetUIElementResize(sourceSender, ref resizeLeft, ref resizeRight, ref resizeUp, ref resizeDown);
        ...
        private void ResetUIElementResize(UIElement sourceSender, ref bool resizeLeft,  ref bool resizeRight,ref bool resizeUp, ref bool resizeDown)
        {
